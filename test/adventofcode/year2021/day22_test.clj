...
(def example-input
  (day/parse-input "on x=-20..26,y=-36..17,z=-47..7
...
(def example-input-part2
  (day/parse-input "on x=-5..47,y=-31..22,z=-19..33
...
(deftest part1-example-larger
  (is (= (day/part1 example-input) 590784)))
